...
int main(int argc, char *argv[]) {
    std::cout << "=== gopher-orch + gopher-mcp Integration Example ===" << std::endl;
    std::cout << std::endl;
    ...
    if (calculator_tool.description.has_value()) {
        std::cout << "   Description: " << calculator_tool.description.value() << std::endl;
    }
    std::cout << std::endl;
    ...
    sample_resource.description = make_optional(
        std::string("Sample JSON data resource for testing"));
    ...
    if (sample_resource.mimeType.has_value()) {
        std::cout << "   MIME Type: " << sample_resource.mimeType.value() << std::endl;
    }
    std::cout << std::endl;
    ...
    greeting_prompt.description = make_optional(
        std::string("A simple greeting prompt"));
    ...
    greeting_prompt.arguments = make_optional(std::vector<PromptArgument>{name_arg});

    std::cout << "4. MCP Prompt:" << std::endl;
    std::cout << "   Name: " << greeting_prompt.name << std::endl;
    if (greeting_prompt.description.has_value()) {
        std::cout << "   Description: " << greeting_prompt.description.value() << std::endl;
    }
    if (greeting_prompt.arguments.has_value()) {
        std::cout << "   Arguments: " << greeting_prompt.arguments.value().size() << std::endl;
    ...
    std::cout << "   Created JSON object with greeting and version info" << std::endl;
    std::cout << std::endl;
    ...
    std::cout << "   This demonstrates gopher-orch extending gopher-mcp capabilities" << std::endl;
    std::cout << std::endl;

    std::cout << "=== Example Complete ===" << std::endl;
    std::cout << "The gopher-orch library successfully integrates with gopher-mcp!" << std::endl;
